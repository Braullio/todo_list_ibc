...
RSpec.describe CardsController, type: :controller do
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new List' do
        expect do
          post :create, params: { title: Faker::FunnyName.name, description: Faker::Lorem.sentence, list_id: list.id }
    ...
    context 'with invalid params' do
      it 'not informad title' do
        expect do
          put :create, params: { list_id: list.id, description: Faker::Lorem.sentence }
        end.to change(Card, :count).by(0)
      end

      it 'not informad list_id' do
        expect{
          put :create, params: { title: Faker::FunnyName.name }
  ...
  context 'with valid params' do
    ...
    it 'updates the requested board' do
      patch :update, params: { id: card.id, card_id: card.id, list_id: list.id, description: Faker::Lorem.sentence, title: Faker::FunnyName.name }
  ...
  describe 'DELETE #destroy' do
    ...
    it 'destroys the requested board' do
      delete :destroy, params: { card_id_del: card.id, id: list.id}
