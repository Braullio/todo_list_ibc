...
RSpec.describe ListsController, type: :controller do
    ...
    context 'with valid params' do
      it 'creates a new List' do
        expect do
          ...
          post :create, body: { list_new: @list_new }.to_json, as: :json, session: valid_session
  ...
  context 'with valid params' do
    ...
    it 'updates the requested board' do
      patch :update, params: { id: list.id, list_id: list.id, list_title: Faker::FunnyName.name }, session: valid_session
  ...
  describe 'DELETE #destroy' do
    ...
    it 'destroys the requested board' do
      delete :destroy, params: { list_id_del: list.id, id: list.id}, session: valid_session
